...
<head>
    ...
    <title>Credit Note {{ $creditNote->credit_note_id }} – Supplier | 22UniMart</title>
...
<div class="main">
    ...
    <div class="topbar">
        <div style="font-size:0.85rem;color:#7a8fa8;">
            <a href="{{ route('supplier.credit-notes.index') }}" style="color:#4a90d9;text-decoration:none;font-weight:600;">Credit Notes</a>
    ...
    <div class="content">
        ...
        <div class="page-header print-hide">
            ...
            <div class="header-actions">
                <a href="{{ route('supplier.credit-notes.index') }}" class="btn btn-back">
                    ← Back
                </a>
        ...
        <div class="doc-card">
            ...
            <div class="doc-footer">
                <div class="doc-footer-note">
                    This credit note is auto-generated and is a read-only document.
                </div>
