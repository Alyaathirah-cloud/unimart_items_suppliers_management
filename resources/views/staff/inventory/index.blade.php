...
@section('content')
    <div class="page-header">
        <div>
            ...
            <div class="page-sub">View and manage current stock levels, monitor reorder points, and track expiring goods.</div>
        </div>
    ...
    <form method="GET" action="{{ route('staff.inventory.index') }}" id="filterForm">
        <div class="filter-bar">
            <div class="filter-search">
                ...
                <input type="text" name="keyword" placeholder="Search by item name or supplier..." value="{{ $keyword ?? '' }}">
            </div>
                        ...
                        <td>
                            <div class="actions">
                                ...
                                @if($item->quantity > 0 && ($isExpired || $isDamaged) && !$hasPendingReturn && $item->supplier_id)
                                    <a href="{{ route('owner.return-requests.create', array_filter(['item_id' => $item->id])) }}" class="btn btn-rr">↩ Return</a>
                                @endif
                            </div>
                        </td>
                    </tr>
