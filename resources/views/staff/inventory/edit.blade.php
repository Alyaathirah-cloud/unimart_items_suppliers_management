...
@push('styles')
<style>
    .content-center { display: flex; flex-direction: column; max-width: 900px; margin: 0 auto; width: 100%; }
...
@section('breadcrumbs')
    <a href="{{ route('staff.inventory.index') }}">Inventory</a> › <span style="color:#0f2044;">Edit Item</span>
@endsection
...
<div class="content-center">
    ...
    <div class="form-card">
        <form action="{{ route('staff.inventory.update', $item) }}" method="POST">
            @csrf
            @method('PUT')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateSellingPrice() {
            ...
            } else if (!isNaN(currentSellingPrice) && currentSellingPrice > 0) {
                sellingPriceDisplay.value = 'RM ' + currentSellingPrice.toFixed(2);
            } else {
