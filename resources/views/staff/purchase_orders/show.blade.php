        ...
        <div class="page-header">
            ...
            <div class="po-meta">
                ...
                @if($purchaseOrder->status === 'Pending')
                    <a href="{{ route('staff.po.edit', $purchaseOrder) }}" style="font-size:.8rem;font-weight:600;color:#3b82f6;text-decoration:none">✏ Edit Order</a>
                @endif
            </div>
        </div>
                    ...
                    <div class="invoice-card-inner" id="invoiceCardInner">
                            ...
                            <div style="display:flex;flex-direction:column;gap:12px;">
                                ...
                                <div style="display:flex;gap:12px;flex-wrap:wrap; margin-top:8px;">
                                    ...
                                    <a href="{{ route('staff.invoice.export-pdf', $purchaseOrder->invoice) }}" class="btn btn-secondary" style="padding:10px 16px; text-decoration:none;">Export PDF</a>
                                </div>
                            </div>
                        @else
    ...
    <div class="modal-overlay" id="inventoryReminderModal">
        <div class="modal-box">
            ...
            <div class="modal-actions">
                <a href="{{ route('staff.inventory.index') }}" class="btn btn-primary">Update Inventory</a>
...
<div class="modal-overlay" id="invoiceModal">
    <div class="modal-box">
        ...
        <div class="modal-footer">
            ...
            <a href="{{ route('staff.invoice.export-pdf', $purchaseOrder->invoice) }}" class="btn-export-pdf">⬇ Export to PDF</a>
        </div>
    </div>
</div>
@endif
...
<script>
    const pollInterval = setInterval(() => {
        fetch('{{ route('staff.po.invoice-status', $purchaseOrder) }}')
            .then(r => r.json())
            .then(data => {
