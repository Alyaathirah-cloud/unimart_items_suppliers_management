...
@section('breadcrumbs')
    <a href="{{ route('staff.po.index') }}">Purchase Orders</a> › <span style="color:#0f2044;">Edit</span>
@endsection
...
<div class="content-wrap">
    <div class="page-header">
        ...
        <a href="{{ route('staff.po.show', $purchaseOrder) }}" class="btn-back">
            ← Back to Order
        </a>
    </div>
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('staff.po.update', $purchaseOrder) }}" id="poForm">
            @csrf
            @method('PATCH')
