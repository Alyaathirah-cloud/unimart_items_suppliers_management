...
@section('title', 'New Supplier – 22UniMart')
...
@section('breadcrumbs')
    <a href="{{ route('staff.suppliers.index') }}">Suppliers</a> › <span style="color:#0f2044;">New Supplier</span>
@endsection
...
<div class="content-center">
    ...
    <form action="{{ route('staff.suppliers.store') }}" method="POST" class="form-container">
        @csrf
                ...
                <div class="form-group" style="flex:1;">
                    ...
                    <div style="display:flex;align-items:center;gap:10px;background:#f4f6fb;border-radius:8px;padding:14px 16px;">
                        ...
                        <div>
                            ...
                            <div class="form-text">When enabled, the supplier receives an email invite to access the portal.</div>
                        </div>
                    </div>
        ...
        <div class="form-card">
            <div class="card-header">
                <div class="card-line"></div>
                <div class="card-title">Return Policy</div>
            </div>
                ...
                <div class="form-group" style="flex:1;">
                    ...
                    <div style="display:flex;align-items:center;gap:10px;background:#f4f6fb;border-radius:8px;padding:14px 16px;">
                        ...
                        <input type="checkbox" id="accepts_returns" name="accepts_returns" value="1"
                               {{ old('accepts_returns', true) ? 'checked' : '' }}>
                        <div>
                            <div style="font-size:0.9rem;font-weight:600;color:#0f2044;">Supplier accepts return of expired or damaged stock</div>
                            <div class="form-text">When enabled, the Return Request page will recommend "Return to Supplier". When disabled, it will recommend "Dispose" as no credit can be claimed.</div>
                        </div>
                    </div>
        ...
        <div class="form-actions">
            <a href="{{ route('staff.suppliers.index') }}" class="btn-discard">🗑 Discard Draft</a>
