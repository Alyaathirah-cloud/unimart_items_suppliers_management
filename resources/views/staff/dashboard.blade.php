...
@section('breadcrumbs')
    <a href="{{ route('staff.dashboard') }}">Dashboard</a> › <span style="color:#0f2044;">Overview</span>
@endsection
    ...
    <div class="topbar-right">
        ...
        <div class="topbar-profile" onclick="toggleProfileDropdown()">
            ...
            <div class="profile-dropdown" id="profileDropdown">
                ...
                <a href="{{ route('staff.password.change') }}" class="dropdown-item">🔐 Change Password</a>
...
@section('content')
    ...
    <div class="quick-actions">
        <a href="{{ route('staff.po.create') }}" class="btn-qa btn-qa-primary">➕ Create Purchase Order</a>
        <a href="{{ route('staff.invoice.index') }}" class="btn-qa">📄 View Invoices</a>
        <a href="{{ route('staff.rr.index') }}" class="btn-qa">↩ View Return Requests</a>
        <a href="{{ route('staff.cn.index') }}" class="btn-qa">💳 View Credit Notes</a>
    </div>
    ...
    <div class="critical-grid">
        <div class="crit-card">
            <div class="crit-header orange">
                ...
                <a href="{{ route('staff.inventory.index', ['status' => 'low_stock']) }}" class="view-all">View all</a>
            </div>
            <div class="crit-body">
        ...
        <div class="crit-card">
            <div class="crit-header yellow">
                ...
                <a href="{{ route('staff.inventory.index', ['status' => 'near_expiry']) }}" class="view-all">View all</a>
            </div>
            <div class="crit-body">
        ...
        <div class="crit-card">
            <div class="crit-header blue">
                ...
                <a href="{{ route('staff.po.index') }}" class="view-all">View all</a>
            </div>
            <div class="crit-body">
