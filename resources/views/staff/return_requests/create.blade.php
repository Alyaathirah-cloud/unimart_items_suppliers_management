...
@section('breadcrumbs')
    <a href="{{ route('staff.rr.index') }}">Return Requests</a> › <span style="color:#0f2044;">Create</span>
@endsection
...
@section('content')
    <div class="center-form">
        <div class="page-header">
            ...
            <div>
                <a href="{{ route('staff.rr.index') }}" class="btn-back">
        ...
        <form action="{{ route('staff.rr.store') }}" method="POST" id="returnForm">
            @csrf
            ...
            <div class="action-row">
                ...
                <a href="{{ route('staff.rr.index') }}" class="btn-cancel">Cancel</a>
            </div>
        </form>
    </div>
    </div>
