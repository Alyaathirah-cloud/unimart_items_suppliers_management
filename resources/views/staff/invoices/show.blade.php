...
@section('breadcrumbs')
    <div class="breadcrumb" style="display: inline-flex;">
        <a href="{{ route('staff.invoice.index') }}">Invoices</a>
...
<div class="page-header" style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom: 24px;">
    ...
    <a href="{{ route('staff.invoice.index') }}" class="btn-action-outline" style="width:auto; padding: 8px 16px;">
...
<div class="grid-layout">
                    ...
                    <table style="width: 100%; border-collapse: collapse; min-width: 600px;">
                        ...
                        <tbody>
                            @foreach($invoice->returnRequests as $rr)
                                <tr>
                                    <td style="padding: 16px 24px; border-bottom: 1px solid #f0f4f8;"><a href="{{ route('staff.rr.show', $rr) }}" style="color: #2a5fd4; text-decoration: none; font-weight: 600;">{{ $rr->return_number }}</a></td>
    ...
    <div class="col-actions">
            ...
            <div style="padding: 0;">
                @forelse($invoice->lines as $line)
                    ...
                    @php
                        ...
                        $goodReceived = ($poItem && !is_null($poItem->good_quantity)) ? (int) $poItem->good_quantity : $purchased;
        ...
        <div class="card" style="padding: 24px;">
            ...
            <a href="{{ route('staff.invoice.export-pdf', $invoice) }}" class="btn-action-primary">
            ...
            @if($invoice->purchaseOrder)
                <a href="{{ route('staff.po.show', $invoice->purchaseOrder) }}" class="btn-action-outline">
            ...
            <a href="{{ route('staff.rr.create', ['invoice_id' => $invoice->id]) }}" class="btn-action-outline" style="margin-bottom: 0;">
