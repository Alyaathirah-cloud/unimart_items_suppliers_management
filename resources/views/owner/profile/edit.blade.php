...
@section('content')
    ...
    <div class="profile-layout">
        ...
        <div class="avatar-card">
            ...
            <div class="avatar-divider"></div>
            <a href="{{ route('owner.password.change') }}" class="btn-secondary" style="width:100%;justify-content:center;background:rgba(255,255,255,0.1);border-color:rgba(255,255,255,0.15);color:#fff;">
                🔐 Change Password
            </a>
        </div>
