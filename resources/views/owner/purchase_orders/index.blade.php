...
@section('topbar')
    ...
    <form method="GET" action="{{ route('owner.purchase-orders.index') }}" class="topbar-search">
...
<div class="section">
    <div class="section-header">
        ...
        <div style="display: flex; gap: 10px; align-items: center;">
            <a href="{{ route('owner.purchase-orders.create') }}" class="btn-create" style="padding: 7px 16px; font-size: 0.82rem;">
