...
<div class="main">
    ...
    <div class="topbar">
        <div style="font-size:0.85rem;color:#7a8fa8;">
            <a href="{{ route('owner.credit-notes.index') }}" style="color:#4a90d9;text-decoration:none;font-weight:600;">Credit Notes</a>
    ...
    <div class="content">
        ...
        <div class="page-header print-hide">
            ...
            <div class="header-actions">
                <a href="{{ route('owner.credit-notes.index') }}" class="btn btn-back">
                    ← Back
                </a>
                <a href="{{ route('owner.credit-notes.export-single-pdf', $creditNote) }}" class="btn btn-outline">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                    Export CSV
                </a>
                <button onclick="window.print()" class="btn btn-dark">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M17 17h2a2 2 0 0 0 2-2v-4a2 2 0 0 1 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6a2 2 0 0 1 2 2v4a2 2 0 0 0 2 2h2"/><path d="M9 21h6"/></svg>
                    Print
                </button>
                    Export PDF
                </a>
            ...
            <div class="doc-info">
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <a href="{{ route('owner.return-requests.index') }}">
