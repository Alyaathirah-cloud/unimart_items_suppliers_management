            ...
            <div class="card-body">
                <div class="field-row">
                    <div class="field">
                        ...
                        <div class="field-value">
                            <span class="badge badge-{{ strtolower($returnRequest->status) === 'pending' ? 'pending' : (strtolower($returnRequest->status) === 'approved' ? 'approved' : 'rejected') }}">{{ $returnRequest->status }}</span>
                        </div>
                    </div>
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <div class="field-value">{{ $returnRequest->reason }}</div>
                    </div>
                    <div class="field">
                        <div class="field-label">Quantity</div>
                        <div class="field-value">{{ number_format($returnRequest->quantity) }}</div>
                    </div>
                </div>
                ...
                <div class="field-row">
                    <div class="field">
                        ...
                        <div class="field-value">{{ optional($returnRequest->item)->name ?? 'N/A' }}</div>
                    </div>
                    <div class="field">
                        <div class="field-label">Category</div>
                        <div class="field-value">{{ optional($returnRequest->item)->category ?? '—' }}</div>
                    </div>
                    <div class="field">
