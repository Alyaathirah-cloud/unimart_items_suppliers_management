...
<head>
    ...
    <title>Add New Item – 22UniMart</title>
...
<div class="main">
    <div class="topbar">
        <div class="breadcrumbs"><a href="{{ route('owner.items.index') }}">Inventory</a> › <span style="color:#0f2044;">Add Item</span></div>
    ...
    <div class="content">
        ...
        <div class="page-sub">Create a new product listing and keep stock details up to date within the owner portal.</div>
        ...
        <div class="form-card">
            <form action="{{ route('owner.items.store') }}" method="POST">
                @csrf
