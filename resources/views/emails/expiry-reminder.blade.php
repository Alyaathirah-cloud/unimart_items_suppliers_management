...
<body style="font-family: Arial, sans-serif; background:#f4f4f4; padding:20px;">
    <div style="max-width:600px; margin:auto; background:#fff; border-radius:8px; padding:30px; box-shadow:0 2px 8px rgba(0,0,0,0.07);">
        <h2 style="color:#d97706; margin-top:0;">⏰ Expiry Reminder</h2>
        <p>The following product is nearing its expiry date. Please inspect the stock and take necessary action.</p>
        <table style="width:100%; border-collapse:collapse; margin-top:15px; background:#fffbeb; border-radius:6px; overflow:hidden;">
            ...
            <tr>
                <td style="padding:12px 16px; font-weight:bold;">Expiry Date</td>
                <td style="padding:12px 16px; color:#dc2626; font-weight:bold;">{{ $expiryDate }}</td>
            </tr>
        </table>
        <p style="margin-top:20px;">Consider creating a Return Request or marking this item for disposal before it expires.</p>
